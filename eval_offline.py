...
def test_net(net, img, each_image_path, cuda):
...
# def recognition():
#     img_id =request.values.get("ImgId")
#     date_time = request.values.get("DateTime")
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        for each_image_path in img_path:
            ...
            test_net(net, img, each_image_path, args.cuda)
